 ...
 /*
    ...
    tail_rec_sum(n:i32, running_total: mut i32){ //signature remains same
       while n!=0 { //if replaced by while with opposite condition
         running_total = running_total + n //2nd argument of recursive call
    ...
    Now lets get back to our problem. We need to find whether drop code generated by compiler for our stack implementation is tail
